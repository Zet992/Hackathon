...
public class Script : MonoBehaviour {
	...
	public string url = "ws://localhost:3000/unity-ws";
	...
	{
		float x = transform.position.x / 10000;
		float y = transform.position.z / 10000;
		string answ = string.Format("%{0}%{1}%", x.ToString("G17", CultureInfo.InvariantCulture), y.ToString("G17", CultureInfo.InvariantCulture));
		return answ;
	}
}
